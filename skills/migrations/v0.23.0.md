...
feature_pitch:
  ...
  description: |
    ...
    `personal/reflections/...`, originals to `ideas/...`,
    ...
    same motif, a pattern page is written to `personal/patterns/...`
...
Reflections: `personal/reflections/YYYY-MM-DD-<topic>-<hash[:6]>`
Originals:   `ideas/YYYY-MM-DD-<idea>-<hash[:6]>`
Patterns:    `personal/patterns/<theme>`
