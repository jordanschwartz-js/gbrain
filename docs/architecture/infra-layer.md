...
CHUNKING (3 strategies, configurable)
  ...
  ↓
EMBEDDING (OpenAI or Ollama, 2560 dimensions by default)
...
| `src/core/embedding.ts` | OpenAI/Ollama embedding with batch, retry, backoff |
...
- **content_chunks** — pgvector halfvec(2560) embedding, chunk_source (compiled_truth|timeline)
